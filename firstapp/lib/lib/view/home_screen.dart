                                ...
                                children: <Widget>[
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Text(
                                          controller.propertyModel[index].type.toString(),
                            ...
                            child: InkWell(
                              ...
                              child: Padding(
                                ...
                                child: GetBuilder<SavingsController>(
                                  init: SavingsController(),
                                  builder: (controller1)   => GestureDetector(
                                    onTap: (){

                                      // controller1.addSaving(
                                      //   SavingsModel(
                                      //     locationn: controller.propertyModel[index].locationn,
                                      //     area: controller.propertyModel[index].area,
                                      //     type: controller.propertyModel[index].type,
                                      //     noOfRooms: controller.propertyModel[index].noOfRooms,
                                      //     noOfBaths: controller.propertyModel[index].noOfBaths,
                                      //     amenty: controller.propertyModel[index].amenty,
                                      //     paymentType: controller.propertyModel[index].paymentType,
                                      //     price: controller.propertyModel[index].price,
                                      //     downPayment: controller.propertyModel[index].downPayment,
                                      //     installmentValue: controller.propertyModel[index].installmentValue,
                                      //     description: controller.propertyModel[index].description,
                                      //     brokerPhone: controller.propertyModel[index].brokerPhone,
                                      //     brokerEmail: controller.propertyModel[index].brokerEmail
                                      //   )
                                      // );
                                      ...
                                      // // if(FirebaseAuth.instance.currentUser!.email == controller.propertyModel[index].userEmail){
                                      ...
                                      //     'type': controller.propertyModel[index].type ,
                                      //     'price': controller.propertyModel[index].price,
                                      //     'number of rooms':controller.propertyModel[index].noOfRooms,
                                      //     'number of baths': controller.propertyModel[index].noOfBaths,
                                      //     'Amenties': controller.propertyModel[index].amenty,
                                      //     'payment type': controller.propertyModel[index].paymentType,
                                      //     'down payment': controller.propertyModel[index].downPayment,
                                      //     'installment value': controller.propertyModel[index].installmentValue,
                                      //     'description': controller.propertyModel[index].description,
                                      //   }
                                      // );
                                      // }
